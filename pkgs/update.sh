...
if [ -z "$1" ]; then
  repos="mercode-jbrawn mercode-bazik mercode-artworks papirus-mer-icon-theme merculator meros-welcome-legacy distrocards dwarfs2019 nixinstall merost deezloader-remix webkit2-launcher mer-cursor conf-tool meros-grub"
else
  repos="$*"
fi
